...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { category: @advertisement.category, category: @advertisement.category, shop_id: @advertisement.shop_id }
    end
  ...
  test "should update advertisement" do
    patch :update, id: @advertisement, advertisement: { category: @advertisement.category, category: @advertisement.category, shop_id: @advertisement.shop_id }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
